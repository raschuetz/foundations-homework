...
# TA-COMMENT: (-0.5) So technically this doesn't sort the original list, but rather creates a sorted copy of the original list. You'd want to use the method .sort() to sort the original list permanently.
